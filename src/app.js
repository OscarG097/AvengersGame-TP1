document.addEventListener('DOMContentLoaded', () => {
    ...
    function dragEnd() {
        ...
        if (squareIdBeingReplaced && validMove) {
            ...
            squares[squareIdBeingReplaced].style.backgroundImage = logoBeingReplaced
            squares[squareIdBeingDragged].style.backgroundImage = logoBeingDragged
        } else squares[squareIdBeingDragged].style.backgroundImage = logoBeingDragged
    }
    ...
    function checkRowForThree() {
        for (i = 0; i < 61; i++) {
            ...
            if (rowOfThree.every(index => squares[index].style.backgroundImage === decidedLogo && !isBlank)) {
                score += 3
    ...
    function checkColumnForThree() {
        for (i = 0; i < 47; i++) {
            ...
            if (columnOfThree.every(index => squares[index].style.backgroundImage === decidedLogo && !isBlank)) {
                score += 3
                scoreDisplay.innerHTML = score
